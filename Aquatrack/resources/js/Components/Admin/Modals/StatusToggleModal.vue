        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-full bg-yellow-100 mr-3"
                        >
                            <TriangleAlert class="w-4 h-4 text-yellow-600" />
                        </div>
                        <h3
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 dark:text-gray-300 mb-2">
                            ...
                            <span class="font-medium">{{ action }}</span> this
                            user?
                        </p>
                        <div
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{
                                action === "deactivate"
                                    ? "The user will no longer be able to access their account until reactivated."
                                    : "The user will regain access to their account and all associated features."
                            }}
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <button
                            ...
                            "
                            class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px]"
                        >
                            <Loader2
                                v-if="isProcessing"
